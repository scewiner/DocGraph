...
@register_model("zhanggraph")
class ZhangGraphModel(FairseqEncoderDecoderModel):
    """
...
@register_model_architecture("zhanggraph", "zhanggraph_tiny")
...
@register_model_architecture("zhanggraph", "zhanggraph")
...
@register_model_architecture("zhanggraph", "zhanggraph_iwslt_de_en")
def zhanggraph_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
...
@register_model_architecture("zhanggraph", "zhanggraph_wmt_en_de")
def zhanggraph_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("zhanggraph", "zhanggraph_vaswani_wmt_en_de_big")
def zhanggraph_vaswani_wmt_en_de_big(args):
