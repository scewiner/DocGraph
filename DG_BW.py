...
@register_model("DGBackward")
class DGBackwardModel(FairseqEncoderDecoderModel):
    """
...
class TransformerDecoder(FairseqIncrementalDecoder):
    ...
    def extract_features_scriptable(
        ...
        x += encoder_out['sent_order'][0].transpose(0,1)
...
@register_model_architecture("DGBackward", "DGBackward_tiny")
...
@register_model_architecture("DGBackward", "DGBackward")
...
@register_model_architecture("DGBackward", "DGBackward_iwslt_de_en")
def DGBackward_iwslt_de_en(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
...
@register_model_architecture("DGBackward", "DGBackward_wmt_en_de")
def DGBackward_wmt_en_de(args):
    base_architecture(args)


# parameters used in the "Attention Is All You Need" paper (Vaswani et al., 2017)
@register_model_architecture("DGBackward", "DGBackward_vaswani_wmt_en_de_big")
def DGBackward_vaswani_wmt_en_de_big(args):
